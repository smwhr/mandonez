    ...
    function continueStory(firstTime) {
        ...
        while(story.canContinue) {
            ...
            for(var i=0; i<tags.length; i++) {
                ...
                // CLASS: className
                else if( splitTag && splitTag.property == "DIDASCALIE" ) {
                    customClasses.push("didascalie");
                }
            ...
            if(paragraphText.startsWith(">>>")){
                textCommand = paragraphText.replace(">>>", "").trim();
                if(textCommand.toUpperCase() == "DIV"){
                    var divider = document.createElement('hr');
                    storyContainer.appendChild(divider);
                }
                if(textCommand.startsWith('§')){
                    var sectionElement = document.createElement('h2');
                    sectionElement.innerHTML = textCommand.replace('§', '').trim();
                    storyContainer.appendChild(sectionElement);
                }
        ...
        story.currentChoices.forEach(function(choice) {
            ...
            for(var i=0; i<choiceTags.length; i++) {
                ...
                if( splitTag.property == "EXIT" ) {
                    customClasses.push("exit");
                    isDialog = false;
                }else if( splitTag.property == "WAIT" ) {
                    customClasses.push("wait");
                    isDialog = false;
                }else if( splitTag.property == "INVESTIGATE" ) {
                    customClasses.push("investigate");
                    isDialog = false;
                }else if( splitTag.property == "ACTION" ) {
                    customClasses.push("action");
                    isDialog= false;
                }else if( splitTag.property == "EXTRA" ) {
                    isDialog= false;
                }
            ...
            if(isClickable){
                ...
                choiceAnchorEl.addEventListener("click", function(event) {
                    ...
                    // find all older p and hr elements and them a .history class
                    var pElements = storyContainer.querySelectorAll("p, hr");
